...
import { ChatMessage } from '@ai-gateway/shared-types';
...
const playgroundSlice = createSlice({
  ...
  reducers: {
    ...
    setTotalTokens(state, action: PayloadAction<number>) { state.totalTokens = action.payload; },
  },
});

export const { addMessage, clearMessages, setTemperature, setMaxTokens, setSystemMessage, setSelectedModel, setSending, setTotalTokens } = playgroundSlice.actions;
