...
export default function DashboardLoading() {
  ...
  return (
    <div className="min-h-screen bg-background relative flex flex-col">
      ...
      <div className="max-w-[1400px] w-full mx-auto flex-1 px-3 py-3 sm:px-5 sm:py-8">
        <div className="grid gap-4 sm:gap-6 lg:grid-cols-[240px_minmax(0,1fr)] lg:items-start">
          ...
          <div className="min-w-0">
            <div className="flex h-[60vh] min-h-[320px] flex-col items-center justify-center rounded-xl sm:rounded-[1.125rem] md:rounded-[1.25rem] border border-border bg-white px-5 py-12 text-text-secondary shadow-sm sm:min-h-[480px] sm:px-6 sm:py-14">
